...
/*
* @route   GET /api/menu/:id/items
* @desc    Obtiene todos los items (platos) de un menú específico.
* @access  Public (o Admin, según se necesite)
* @note    Este es el endpoint que faltaba para la validación del admin.
*/
